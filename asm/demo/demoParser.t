...
(Command (JE (Label (ASMLabel "fibonachchEnd"))));
(Command (CMP (RegToExpr (Reg64 "RBX") (Const (ASMConst "2")))));
(Command (JE (Label (ASMLabel "fibonachchTwo"))));
